...
import { Chat, FileInfo, Mode } from "@/utils/types";
...
// Simple Pricing Modal Component
    ...
    <div className={styles.pricingOverlay}>
      <div className={styles.pricingModal}>
        ...
        <p className={styles.pricingDescription}>
          Unlock premium features with unlimited access
        </p>
        <button
        ...
        <p className={styles.pricingTestNote}>
          <strong>Test Mode:</strong> Use card 4242 4242 4242 4242
        </p>
        <button className={styles.pricingClose} onClick={onClose}>
          Close
        </button>
      </div>
    </div>
